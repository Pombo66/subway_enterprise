  ...
  return (
    <div className="p-4 h-full flex flex-col">
      ...
      <div className="mb-4 space-y-2">
        <label className="block text-xs font-medium text-gray-700">Context (Optional)</label>
      ...
      <div className="flex-1 flex flex-col">
        <label className="block text-xs font-medium text-gray-700 mb-2">Your Question</label>
        <textarea
          className={`flex-1 border rounded-md px-3 py-2 text-sm resize-none focus:outline-none focus:ring-2 focus:border-transparent ${
            isOverLimit 
